...
//DB CONNECTION //
  ...
  $con =  $connection->connectToDatabase(); // connected to the database
...
$amount = $_POST['vpc_Amount'];
$tx_ref = $_POST['vpc_MerchTxnRef'];
 
$amount_original = $amount/100;

$query = 'INSERT INTO donations (fname, lname, address, email, mobile, amount, payment_status,tx_reference)
 VALUES ("'.$fname.'","'.$lname.'","'.$address.'","'.$email.'","'.$mobile.'",'.$amount_original.',0,"'.$tx_ref.'")';
 mysqli_query($con,$query );
 
$connection->closeConnection();
//
$SECURE_SECRET = "1CC6D29A3F39226E95564E09E24B252F";
